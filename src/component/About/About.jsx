    ...
    <>
      <div className="bg-white">
            ...
            <article className="relative p-6 md:p-8 md:col-span-2">
              ...
              <div className="space-y-8">
                <p className="text-base sm:leading-relaxed md:text-2xl">
                  ...
                  memorable year. Let’s embark on this educational journey
        ...
        <section className="text-center py-12 px-4">
          ...
          <div className="flex justify-center space-x-8 mt-8 animate-fadeIn">
            <div className="transition transform hover:scale-110">
              ...
              <p className="text-gray-700">Coaching Center</p>
            </div>
            <div className="transition transform hover:scale-110">
            ...
            <div className="transition transform hover:scale-110">
              ...
              <p className="text-gray-700">Study Libraries</p>
            </div>
          </div>
        </section>
        ...
        <div className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-r from-green-50/50 via-teal-50 to-green-50/50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800">
          <h1 className="mx-auto md:max-w-4xl font-display text-wrap text-4xl font-bold tracking-normal text-white-300 dark:text-gray-300 sm:text-7xl">
            ...
            <span className="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
              ...
              <span className="relative"> with Digital</span>
            </span>
          </h1>
        ...
        <section className="text-center py-12 px-4">
          <h2 className="text-2xl font-bold">Our Libraries</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mt-8">
            <div className="p-4 shadow-lg rounded-lg bg-green-100 hover:bg-green-200 transition-colors">
              <h3 className="text-xl font-bold">Amarpatan</h3>
            </div>
            <div className="p-4 shadow-lg rounded-lg bg-green-100 hover:bg-green-200 transition-colors">
              <h3 className="text-xl font-bold">maiher</h3>
            </div>
            <div className="p-4 shadow-lg rounded-lg bg-green-100 hover:bg-green-200 transition-colors">
              <h3 className="text-xl font-bold">Rewa</h3>
            </div>
            <div className="p-4 shadow-lg rounded-lg bg-green-100 hover:bg-green-200 transition-colors">
              <h3 className="text-xl font-bold">Satna</h3>
            </div>
          </div>
        </section>

        <section className="bg-gray-100 py-12 px-4">
          <h2 className="text-2xl font-bold text-center">Our Library Facilities</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 max-w-5xl mx-auto">
            <div className="p-4 shadow-lg rounded-lg bg-white hover:shadow-xl transition-shadow">
              <h3 className="text-xl font-bold">Free High Speed WIFI</h3>
            </div>
            <div className="p-4 shadow-lg rounded-lg bg-white hover:shadow-xl transition-shadow">
              <h3 className="text-xl font-bold">live Test Series on Computer</h3>
            </div>
            <div className="p-4 shadow-lg rounded-lg bg-white hover:shadow-xl transition-shadow">
              <h3 className="text-xl font-bold">RO Water With Water Cooler</h3>
            </div>
            <div className="p-4 shadow-lg rounded-lg bg-white hover:shadow-xl transition-shadow">
              <h3 className="text-xl font-bold">CCTV Servillance 24*7 </h3>
            </div>
            <div className="p-4 shadow-lg rounded-lg bg-white hover:shadow-xl transition-shadow">
              <h3 className="text-xl font-bold">Personal Locker</h3>
            </div>
            <div className="p-4 shadow-lg rounded-lg bg-white hover:shadow-xl transition-shadow">
          ...
          <div className="py-10  max-w-screen-lg mx-auto">
            ...
            <div className="grid grid-cols-3 col-gap-10">
              <div className="text-center bg-white">
                <img className="w-100" src="img/mohitSir.png" />
                <div className="p-4">
		...
		C93.282,101.457,89.661,116.261,93.282,126.483z"
              ...
              <div className="text-center bg-white">
                <img
                  className="ml-7 sm:ml-20 sm:h-[14rem] h-24"
                  src="img/dharmu.png"
                />
                <div className="p-4">
                  <div className="text-md">
        ...
        <section className="text-center py-12 px-4 w-full">
          ...
          <div className="mt-8">
            ...
            <div className="p-4 border rounded-lg shadow-md transition transform hover:scale-100 scale-90 mt-4">
              <h3 className="text-xl font-bold">How can I join a study room?</h3>
              <p className="mt-2 text-gray-700">
                You can join by taking membership of our libraries.
              </p>
            </div>
            <div className="p-4 border rounded-lg shadow-md transition transform hover:scale-100 scale-90 mt-4">
              <h3 className="text-xl font-bold">How can I contact the staff?</h3>
              <p className="mt-2 text-gray-700">
