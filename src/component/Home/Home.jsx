    ...
    <>
      <div className="ml-2 w-[91%] sm:w-[97%] ">
        <div className="mt-2">
          <Slider {...settings}>
            {data.map((d) => (
              <div className="flex justify-center items-center" key={d.img}>
      ...
      <section>
        <div className="w-full p-2  sm:p-1 md:p-1 relative">
          <div
            className="bg-cover bg-center text-center overflow-hidden min-h-[500px] sm:h-[90vh] w-full sm:blur-[2px] "
            style={{
          ...
          <div className="sm:w-[70%] mx-auto">
            <div className="mt-3 bg-white rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
              <div className="bg-white relative top-0 -mt-32 sm:-mt-[30rem]">
                <div className="h-full max-h-max w-full bg-gray-800 pt-12 p-4">
                  <div className="grid gap-14 md:grid-cols-3 md:gap-5">
                    {items.slice(0, visible).map((item) => (
                      <div className="rounded-xl bg-white p-6 md:mt-5 text-center shadow-xl" key={item.text}>
                        ...
                        <div className="flex justify-center items-center gap-2">
                          ...
                          <span>-</span>
                          <p className="text-darken px-4 text-gray-500 -ml-3">
                            {item.time}
                          </p>
                        </div>
      ...
      <section>
        <div className="flex flex-col justify-center items-center gap-2 mb-2 ">
          <div className="rounded-lg shadow-lg bg-white sm:max-w-[60rem] hover:border-4 sm:flex justify-center items-center p-7">
            <ReactPlayer
            ...
            <div className="p-6 ">
              <h5 className="text-gray-900 text-xl font-medium mb-2">About US</h5>
              <p className="text-gray-700 text-base text-wrap mb-4">
          ...
          <div className="rounded-lg shadow-lg bg-white sm:max-w-[60rem] hover:border-4  sm:flex justify-center items-center p-7">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-700 text-base mb-4 text-wrap">
          ...
          <div className="rounded-lg shadow-lg bg-white sm:max-w-[60rem] hover:border-4  sm:flex justify-center items-center p-7">
            ...
            <div className="p-6 ">
              <h5 className="text-gray-900 text-xl text-wrap font-medium mb-2">
      ...
      <section className="w-full mx-auto px-10 dark:bg-gray-800 dark:text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-5 w-full">
          <div className="border p-7 rounded-xl bg-white dark:bg-gray-700 drop-shadow-md border-neutral-200/50 col-span-2 flex flex-col gap-y-10 justify-between">
            <div className="flex flex-col gap-y-3.5">
              <p className="font-bold text-xl">Exceptional Teaching Methods</p>
            ...
            <div className="flex flex-col">
              <img
                ...
                className="h-10 w-10"
              />
              <p className="pt-2 text-sm font-semibold">Richa Pathak</p>
          ...
          <div className="border p-7 rounded-xl bg-white dark:bg-gray-700 drop-shadow-md border-neutral-200/50 col-span-3 flex flex-col gap-y-10 justify-between">
            ...
            <div className="flex flex-col">
              <img src="img/ankulSingh.jpg" alt="John Doe" className="h-10 w-10" />
              <p className="pt-2 text-sm font-semibold">Ankul Singh</p>
              <p className="text-sm font-medium text-slate-700/70 dark:text-gray-400">
                Agniveer
              </p>
            </div>
          ...
          <div className="border p-7 rounded-xl bg-white dark:bg-gray-700 drop-shadow-md border-neutral-200/50 col-span-3 flex flex-col gap-y-10 justify-between">
            ...
            <div className="flex flex-col">
              <img src="img/richa.jpg" alt="Jane Doe" className="h-10 w-10" />
              <p className="pt-2 text-sm font-semibold">Richa Gautam</p>
              <p className="text-sm font-medium text-slate-700/70 dark:text-gray-400">
                PATWARI
              </p>
            </div>
          ...
          <div className="border p-7 rounded-xl bg-white dark:bg-gray-700 drop-shadow-md border-neutral-200/50 col-span-2 flex flex-col gap-y-10 justify-between">
            <div className="flex flex-col gap-y-3.5">
              <p className="font-bold text-xl">Providing Best Study Materials</p>
              <p className="font-medium text-slate-700/90 dark:text-gray-300">
            ...
            <div className="flex flex-col">
              <img src="img/rohit.jpg" alt="Rohit Sharma" className="h-10 w-10" />
              <p className="pt-2 text-sm font-semibold">Rohit Sharma</p>
              <p className="text-sm font-medium text-slate-700/70 dark:text-gray-400">
                MP Police
              </p>
            </div>
