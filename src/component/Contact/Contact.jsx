                  ...
                  <li className="flex">
                    ...
                    <div className="ml-4 mb-4">
                      ...
                      <p className="text-gray-600 dark:text-slate-400">
                        Pratik Tower Satna Road
                      </p>
                      <p className="text-gray-600 dark:text-slate-400">
                        Near Sarkari Collage Amarpatan District Satna(M.P.)
                      </p>
                    </div>
                  </li>
                  <li className="flex">
                    ...
                    <div className="ml-4 mb-4">
                      ...
                      <p className="text-gray-600 dark:text-slate-400">
                        Mobile: +91-8815645151
                      </p>
                      <p className="text-gray-600 dark:text-slate-400">
                        Mobile:+91-8889783242
                      </p>
                      <p className="text-gray-600 dark:text-slate-400">
                        Mail: sarkari_job_academy@gmail.com
                      </p>
                    </div>
                  </li>
                  <li className="flex">
                    ...
                    <div className="ml-4 mb-4">
                      ...
                      <p className="text-gray-600 dark:text-slate-400">
                        Monday - Saturday: 08:00 - 17:00 (library + Classes)
                      </p>
                      <p className="text-gray-600 dark:text-slate-400">
                        Saturday &amp; Sunday: 08:00 - 17:00 (library only)
                      </p>
                    </div>
                  </li>
                </ul>
