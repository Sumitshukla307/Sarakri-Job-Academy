            ...
            <div>
              <div className="mt-4 space-y-12">
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium leadi ">Online Lecture</h4>
                    <p className="mt-2 ">
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium leadi ">Advanced Quiz</h4>
                    <p className="mt-2 ">
            ...
            <div className="col-span-2 sm:col-span-1 md:col-span-2 bg-stone-50">
              ...
              >
                <img
                  ...
                  alt=""
                  className="absolute inset-0 h-[25vh] w-full group-hover:scale-105 transition-transform duration-500 ease-in-out"
                />
                <div className="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                <h3 className="z-10 text-2xl font-medium text-white absolute top-0 left-0 p-4 xs:text-xl md:text-3xl">
                  Selected Student
            ...
            <div className="col-span-2 sm:col-span-1 md:col-span-1 bg-sky-50 h-auto md:h-full flex flex-col">
              ...
              >
                <img
                  ...
                  alt=""
                  className="absolute inset-0 h-[30vh] sm:h-full w-full  object-top group-hover:scale-105 transition-transform duration-500 ease-in-out"
                />
                <div className="absolute inset-0 bg-gradient-to-b from-gray-900/25 to-gray-900/5"></div>
                <h3 className="z-10 text-2xl font-medium text-white absolute top-0 left-0 p-4 xs:text-xl md:text-3xl">
                  Academy Event
